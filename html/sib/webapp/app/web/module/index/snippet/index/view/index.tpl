            ...
            <div class="card-body p-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                        ...
                        {*
                        <a href="#"
                            class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">{$row.name}</a>
                ...
                <!--end::Top-->
                <div class="pt-2">
                    <div class="bgi-no-repeat bgi-size-cover rounded" rel="color_{$idx}"
                        style="background-image: url(/app/{$app}/template/images/home/{$row.id}.jpg)">
                    </div>
                ...
                <div class="d-flex align-items-center mb-0">
                    ...
                    <div class="d-flex flex-column font-weight-bold">
                        <a class="text-dark text-hover-primary mb-1 font-size-lg" {if $submenu.type eq 'module' }
                            href="/{$app}/{$submenu.folder}" {if $submenu.target}target="_blank" {/if} {elseif
                            $submenu.type eq 'url' } href="{$submenu.url}" {if $submenu.target}target="_blank" {/if}
                            {/if}>{$submenu.name}</a>
