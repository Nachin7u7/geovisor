{literal}
<script>
    var snippet_form_{/literal}{$subcontrol}{literal}_genus = function() {
        "use strict";
        ...
        var showResponse = function (res, statusText) {
            ...
            snippet_{/literal}{$subcontrol}{literal}_form.getGenus(res.id);
        };
        /**
    ...
    jQuery(document).ready(function() {
        snippet_form_{/literal}{$subcontrol}{literal}_genus.init();
    });
