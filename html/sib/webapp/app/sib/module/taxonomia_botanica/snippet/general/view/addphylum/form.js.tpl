{literal}
<script>
    var snippet_form_{/literal}{$subcontrol}{literal}_phylum = function() {
        "use strict";
        ...
        var showResponse = function (res, statusText) {
            ...
            snippet_{/literal}{$subcontrol}{literal}_form.getPhylum(res.id);
        };
        /**
    ...
    jQuery(document).ready(function() {
        snippet_form_{/literal}{$subcontrol}{literal}_phylum.init();
    });
