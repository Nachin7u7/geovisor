{literal}
<script>
    var snippet_form_{/literal}{$subcontrol}{literal}_family = function() {
        "use strict";
        ...
        var showRequest= function(formData, jqForm, op) {
            ...
            formData.push({name: "item[order_id]", value: order_id});
        ...
        var showResponse = function (res, statusText) {
            ...
            snippet_{/literal}{$subcontrol}{literal}_form.getFamily(res.id);
        };
        /**
    ...
    jQuery(document).ready(function() {
        snippet_form_{/literal}{$subcontrol}{literal}_family.init();
    });
