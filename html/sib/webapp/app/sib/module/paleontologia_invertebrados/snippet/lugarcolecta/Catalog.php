...
namespace App\Sib\Paleontologia_invertebrados\Lugarcolecta;
...
class Catalog extends CoreResources
{
    ...
    public function getMunicipioOptions($id)
    {
         ...
         */
        if ($id != "" && $id > 0) {
            $sql = "select id,sec_prov,provincia,name,zona,id_ut,capital,cod_ut,ine_dpto,
                        ine_prov,ine_mun,lat,lon
    ...
    public function getMunicipioPoint($id)
    {
         ...
         */
        if ($id != "" && $id > 0) {
            $sql = "select id,sec_prov,provincia,name,zona,id_ut,capital,
                        cod_ut,ine_dpto,ine_prov,ine_mun,lat,lon, departamento_id
