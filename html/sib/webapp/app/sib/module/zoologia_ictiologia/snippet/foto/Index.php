...
namespace App\Sib\Module\Zoologia_ictiologia\Snippet\Foto;
...
class Index extends CoreResources
{
    ...
    public function changePortadaSize($fileAddress, $itemId, $id)
    {
    ...
    {
        $msgErro = "<div style='text-align: center; background-color: #fee7dc; vertical-align: center;
                           padding-top: 50px; padding-bottom: 50px;'>
                        <span style='color: red; font-family: Arial, sans-serif; font-size: 26px;'>
                        The file does not exist</span>
                    </div>";
        $item = $this->getItem($id, $itemId);
