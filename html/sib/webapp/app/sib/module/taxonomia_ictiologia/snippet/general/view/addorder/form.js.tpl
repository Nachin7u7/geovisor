{literal}
<script>
    var snippet_form_{/literal}{$subcontrol}{literal}_order = function() {
        "use strict";
        ...
        var showRequest= function(formData, jqForm, op) {
            ...
            formData.push({name: "item[class_id]", value: class_id});
        ...
        var showResponse = function (res, statusText) {
            ...
            snippet_{/literal}{$subcontrol}{literal}_form.getOrder(res.id);
        };
        /**
    ...
    jQuery(document).ready(function() {
        snippet_form_{/literal}{$subcontrol}{literal}_order.init();
    });
