    ...
    <form method="POST"
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-12">
                    <label>{#field_description_area_colecta#}:</label>
                    <input type="text" class="form-control"
                           name="item[description_area_colecta]"
                           value="{$item.description_area_colecta|escape:"html"}"
                           minlength="3"
                           data-fv-string-length___message="{#field_length_description_area_colecta#}"
                    >
                    <span class="form-text text-black-50">{#field_msg_description_area_colecta#}</span>
                </div>
                <div class="col-lg-12">
