    ...
    {if $item.id != "" or $type == 'new'}
        <div class="modal-body">
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    <label>{#field_basisofrecord#}:</label>
                    <div class="input-group">
                        <input type="text" class="form-control number_integer2"
                               name="item[basisofrecord]" value="{$item.basisofrecord|escape:"html"}"
                        >
                        <div class="input-group-append"><span class="input-group-text"><i class="fa fa-info"></i></span></div>
                    </div>
                    <span class="form-text text-muted">{#field_msg_basisofrecord#}</span>
                </div>
{*                <div class="col-lg-4">*}
