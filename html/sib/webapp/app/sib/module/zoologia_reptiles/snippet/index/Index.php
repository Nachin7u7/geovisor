...
namespace App\Sib\Module\Zoologia_reptiles\Snippet\Index;
...
class Index extends CoreResources
{
    ...
    public $folder = "zoologia_reptiles";
    ...
    public function __construct()
    {
         ...
         */
        $this->appInit();
        $this->extraWhere = $this->fkeyField . "= '5'";
    }
    ...
    public function getItemDatatableRows()
    {
        ...
        foreach ($result['data'] as $itemId => $valor) {
            if (isset($result['data'][$itemId]['fecha_inicio'])) {
                $result['data'][$itemId]['fecha_inicio'] =
                    $this->changeDataFormat($valor['fecha_inicio'], "d/m/Y");
            }
